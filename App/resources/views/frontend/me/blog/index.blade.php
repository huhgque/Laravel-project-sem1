                ...
                <div class="card" id="blog_id_{{$blog->id}}">
                    <div class="card-body ">
                        ...
                        <div class="text-center">
                            <div class="text-muted">Bài viết này đã bị chặn</div>
                        </div>
                        @endif
                                                  ...
                                                  <div class="row">
                                                      <div class="col-12">
                                                          <div class="row">
                                                              ...
                                                              <textarea style="height: 50px;" placeholder="Viết bình luận" type="text" name="myComment" id="comment_input_{{$blog->id}}" class="col-9 p-2 resize-none"></textarea>
