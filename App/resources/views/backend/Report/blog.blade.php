  ...
  <div class="container-fluid page-content">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card" >
          <div class="card-body">
            <h4 class="card-title">Danh sách tố cáo bài viết</h4>
              ...
              <table  class="table table-bordered"  >
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{route('blog-single',$report->blog_id)}}">Blog #{{$report->blog_id}}</a></td>
                    <td>{{$report->why}}</td>
