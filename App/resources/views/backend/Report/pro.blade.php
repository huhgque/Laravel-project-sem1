  ...
  <div class="container-fluid page-content">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card" >
          <div class="card-body">
            <h4 class="card-title">Danh sách tố cáo sản phẩm</h4>
              ...
              <table  class="table table-bordered"  >
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="/admin/product/{{$report->pro_id}}">{{$report->GetProduct()->name}}</a></td>
                    <td>{{$report->why}}</td>
