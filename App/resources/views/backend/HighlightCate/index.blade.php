      ...
      >
        <nav aria-label="breadcrumb" class="mt-2">
          <ol class="breadcrumb mb-0 p-0">
            <li class="breadcrumb-item"><a href="{{route('highlight-cate.index')}}">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">
            Highlight Category List
            </li>
          </ol>
        </nav>
        <a href="{{Route('highlight-cate.create')}}" class="btn btn-danger text-white ms-3 d-none d-md-block">
          Add new
        </a>
      </div>
    </div>
  ...
  <div class="container-fluid page-content">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card" >
          <div class="card-body " >
            <h4 class="card-title">Highlight Category List</h4>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <a class="dropdown-item" href="{{Route('highlight-cate.edit',$value->id)}}">
                            <i data-feather="edit-2" class="feather-sm me-2"></i>
                            Edit
                          </a>
                          <form class="dropdown-item" style="cursor: pointer;" action="{{Route('highlight-cate.destroy',$value->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
