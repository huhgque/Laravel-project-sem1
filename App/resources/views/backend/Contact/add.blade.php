                ...
                <hr />
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="text"id="address"name="address"class="form-control"placeholder="Input Category Mini Name" value="{{old('name')}}"/>
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="number"id="phone"name="phone"class="form-control"placeholder="Input Category Mini Name" value="{{old('name')}}"/>
                      @if($errors->has('phone'))
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="email"id="email"name="email"class="form-control"placeholder="Input Category Mini Name" value="{{old('name')}}"/>
                      @if($errors->has('email'))
