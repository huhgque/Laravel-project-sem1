...
<head>
    ...
    <title>Electo City Admin Login</title>
    ...
    <script src="{{url('assets-backend')}}/ckeditor_4.16.1_standard_easyimage/ckeditor/ckeditor.js"></script>
...
<div class="row justify-content-center">
    ...
    <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="w-100">
            <img class="w-100" src="{{asset('common/pageimg/StickyLogo.png')}}" alt="">
        </div>
        <div class="card o-hidden border-0 shadow-lg my-5">
            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    {{-- <div class="col-lg-6 d-none d-lg-block bg-login-image" style="background: url('{{asset('assets-backend/img/pcgem-xanh.jpg')}}')"></div> --}}
                    <div class="col-lg-6 d-none d-lg-block bg-login-image"></div>
                    <div class="col-lg-6">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Login</h1>
                                <div class="msg text-danger text-center">
                                    @if (Session::get('msg'))
                                        {{Session::get('msg')}}
                                    @endif
                                </div>
