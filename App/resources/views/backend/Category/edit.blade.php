                ...
                <hr />
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="text"id="name" name="name"class="form-control"placeholder="Input Category Name"value="{{$category->name}}"
                      />
                    ...
                    <div class="mb-3">
                      ...
                      <div class="row p-3">
                        ...
                        <div class="form-check col-3 form-switch">
                          <input class="form-check-input" name="catemini[]" type="checkbox" value="{{$catemini->id}}" id="catemini_{{$catemini->id}}" {{($category->HasThisSubcate($catemini->id))?'checked':''}}>
