                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <div class="form-check">
                        ...
                        <input type="radio"id="status"name="status"class="form-check-input" value="0" {{($category_mini->status == 0)?'checked':''}}/>Ẩn
                        </label>
                    </div>                 
                        <label class="form-check-label"id="status"name="status">
                          <input type="radio"id="status"name="status"class="form-check-input" value="1" {{($category_mini->status == 1)?'checked':''}}/> Hiện
                        </label>
                    </div>
                  </div> 
