...
<div class="page-breadcrumb border-bottom">
    <div class="row">
      ...
      >
        ...
        <a href="{{Route('category-mini.create')}}" class="btn btn-danger text-white ms-3 d-none d-md-block">
          Add new
        </a>
      </div>
    </div>
  ...
  <div class="container-fluid page-content">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card" >
          <div class="card-body " >
            <h4 class="card-title">Category Mini List</h4>
            ...
            <div class="table-responsive" style="overflow: visible;">
              <table id="file_export" class="table table-bordered">
                ...
                <tbody>
                    @foreach($category_mini as $value)
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <a class="dropdown-item" href="{{Route('category-mini.edit',$value->id)}}">
                            <i data-feather="edit-2" class="feather-sm me-2"></i>
                            Edit
                          </a>
                          <form class="dropdown-item" style="cursor: pointer;" action="{{Route('category-mini.destroy',$value->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
