...
<div class="page-breadcrumb border-bottom">
    <div class="row">
      ...
      >
        ...
        <a href="{{Route('payment.create')}}" class="btn btn-danger text-white ms-3 d-none d-md-block">
          Thêm
        </a>
      </div>
    </div>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <a class="dropdown-item" href="{{Route('payment.edit',$value->id)}}">
                            <i data-feather="edit-2" class="feather-sm me-2"></i>
                            Edit
                          </a>
                          <form class="dropdown-item" style="cursor: pointer;" action="{{Route('payment.destroy',$value->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
