      ...
      >
        <nav aria-label="breadcrumb" class="mt-2">
          <ol class="breadcrumb mb-0 p-0">
            <li class="breadcrumb-item"><a href="{{route('brand.index')}}">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">
              Brand List
            </li>
          </ol>
        </nav>
        <a href="{{Route('brand.create')}}" class="btn btn-danger text-white ms-3 d-none d-md-block">
          Add new
        </a>
      </div>
    </div>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <form class="dropdown-item" style="cursor: pointer;" action="{{Route('brand.destroy',$value->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
