    ...
    return (function(t) {
        ...
        function(t, e, n) {
            ...
            function k(t, n) {
                var i, r, o;
                for (
                    i = 0; i < e.unitsDesc.length &&
                    ((r = e.unitsDesc[i]), !((o = V(r, t, n)) >= 1 && ut(o))); i++
                );
                return r;
            }
                        ...
                        (t.parse = function(e, n) {
                            ...
                            return (!!s.isValid() &&
                                (!a || (a.isValid() && a.isAfter(s)) || (a = null),
                                    ...
                                    !1 === l &&
                                    (s.hasTime() || s.time(0), a && !a.hasTime() && a.time(0)), !a && u && (a = o.getDefaultEventEnd(!s.hasTime(), s)),
                                    new t(s, a, o))
                            );
                        }),
                ...
                p = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.skipHiddenDays = function(t, e, n) {
                            void 0 === e && (e = 1), void 0 === n && (n = !1);
                            for (
                                var i = t.clone(); this.isHiddenDayHash[(i.day() + (n ? e : 0) + 7) % 7];
                    ...
                    return (
                        ...
                        (t.prototype.buildNewDateProfile = function(t, e) {
                            ...
                            return (
                                ...
                                o && ((n = e.applyTimezone(n)), i && (i = e.applyTimezone(i))), !i &&
                    ...
                    return (
                        ...
                        (e.parse = function(t, e) {
                            ...
                            return (
                                r.isArray(t.events) ?
                                (n = t) :
                                r.isArray(t) && (n = { events: t }), !!n && a.default.parse.call(this, n, e)
                            );
                        }),
                    ...
                    return (
                        ...
                        (e.prototype.updateDayTable = function() {
                            for (
                                var t,
                                    ...
                                    a = o.msToUtcMoment(
                                        i.dateProfile.renderUnzonedRange.endMs, !0
                                    ),
                                    l = -1,
                                    u = [],
                                    d = []; s.isBefore(a);
                        ...
                        (e.prototype.renderHeadDateCellHtml = function(t, e, n) {
                            ...
                            return (
                                ...
                                ">" +
                                (a ?
                                    s.buildGotoAnchorHtml({ date: t, forceOff: o.rowCnt > 1 || 1 === o.colCnt },
                                        i
                                    ) :
                                    i) +
                                "</th>"
                    ...
                    return (
                        ...
                        (t.prototype.renderEventFootprints = function(t, e, n, i) {
                            var r,
                                ...
                                s = "fc-helper " + (n || "");
                            for (
                                o = this.eventRenderer.renderFgSegEls(o), r = 0; r < o.length; r++
                            )
                                o[r].el.addClass(s);
                            if (null != i)
                        ...
                        (e.prototype.renderNumberCellHtml = function(t) {
                            ...
                            return s || this.cellWeekNumbersVisible ?
                                ((e = this.getDayClasses(t)),
                                    ...
                                    this.cellWeekNumbersVisible &&
                                    t.day() === n &&
                                    (r += i.buildGotoAnchorHtml({ date: t, type: "week" }, { class: "fc-week-number" },
                                        t.format("w")
                                    )),
                                    s &&
                    ...
                    return (
                        ...
                        (e.parse = function(t, e) {
                            ...
                            return (
                                ...
                                (n = t) :
                                r.isFunction(t) && (n = { events: t }), !!n && s.default.parse.call(this, n, e)
                            );
                        }),
                        (e.prototype.fetch = function(t, e, n) {
                            var i = this;
                    ...
                    return (
                        ...
                        (e.parse = function(t, e) {
                            ...
                            return (
                                "string" == typeof t.url ?
                                (n = t) :
                                "string" == typeof t && (n = { url: t }), !!n && a.default.parse.call(this, n, e)
                            );
                        }),
                    ...
                    return (
                        ...
                        (e.prototype.computeDayRange = function(t) {
                            ...
                            return (
                                ...
                                o <= n && (o = n.clone().add(1, "days")), { start: n, end: o }
                            );
                        }),
                    ...
                    return (
                        ...
                        (t.prototype.removeEventSources = function(t) {
                            ...
                            if (null == t) this.eventManager.removeAllSources();
                                ...
                                for (
                                    e = i.multiQuerySources(t), i.freeze(), n = 0; n < e.length; n++
                                )
                                    i.removeSource(e[n]);
                                i.thaw();
                            }
                        ...
                        (t.prototype.buildCurrentRangeInfo = function(t, e) {
                            ...
                            return (
                                ...
                                ((o = this.getFallbackDuration()),
                                    ...
                                    (a = this.buildRangeFromDuration(t, e, o, s))), { duration: o, unit: s, unzonedRange: a }
                            );
                        }),
        ...
        function(t, e, n) {
            function i(t) {
                ...
                return (
                    ...
                    (r = Boolean(r)), { eventProps: e, startTime: n, duration: i, stick: r }
                );
            }
            Object.defineProperty(e, "__esModule", { value: !0 });
            var r = n(2),
                ...
                renderHeadIntroHtml: function() {
                    ...
                    return this.opt("weekNumbers") ?
                        ((t = i.format(this.opt("smallWeekFormat"))),
                            ...
                            e.axisStyleAttr() +
                            ">" +
                            e.buildGotoAnchorHtml({ date: i, type: "week", forceOff: this.colCnt > 1 },
                                u.htmlEscape(t)
                            ) +
                            "</th>") :
                        '<th class="fc-axis ' +
                ...
                u = (function() {
                    ...
                    return (
                        ...
                        (t.prototype.addEventDef = function(t) {
                            ...
                            for (
                                r.push(t), this.eventDefsByUid[t.uid] = t, e = 0; e < o.length; e++
                            )
                        ...
                        (t.prototype.stop = function(t, e) {
                            ...
                            this.isFollowing &&
                                ...
                                ((this.isFollowing = !1),
                                    ...
                                    t && r && !this.isHidden ?
                                    ((this.isAnimating = !0),
                                        this.el.animate({ top: this.top0, left: this.left0 }, { duration: r, complete: o })) :
                                    o());
                        }),
                ...
                c = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.renderFgSegsIntoContainers = function(t, e) {
                            var n, i;
                            for (
                                n = this.timeGrid.groupSegsByCol(t), i = 0; i < this.timeGrid.colCnt; i++
                            )
